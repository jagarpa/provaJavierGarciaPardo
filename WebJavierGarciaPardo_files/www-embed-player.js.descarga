...
function sa(a,b){a.j={kb:b,ob:!0};a.h=a.m||a.A}
...
function xa(a){var b=a.C.splice(0)[0];(b=a.j=a.j||b)?b.ob?a.h=a.m||a.A:void 0!=b.o&&a.A<b.o?(a.h=b.o,a.j=null):a.h=a.A:a.h=0}
...
function Ba(a){for(;a.h.h;)try{var b=a.i(a.h);if(b)return a.h.F=!1,{value:b.value,done:!1}}catch(c){a.h.i=void 0,sa(a.h,c)}a.h.F=!1;if(a.h.j){b=a.h.j;a.h.j=null;if(b.ob)throw b.kb;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
c.prototype=b.prototype;a.U=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.jn=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
;function Mc(a){return null!==a&&"object"===typeof a&&a.constructor===Object}
var Nc;function Oc(a){switch(typeof a){case "number":return isFinite(a)?a:String(a);case "object":if(Jc&&null!=a&&a instanceof Uint8Array)return Ic(a)}return a}
;function Qc(a,b){if(null!=a)return Array.isArray(a)||Mc(a)?Rc(a,b):b(a)}
...
function Sc(a){a=Oc(a);return Array.isArray(a)?Rc(a,Sc):a}
function Tc(a){return Jc&&null!=a&&a instanceof Uint8Array?new Uint8Array(a):a}
;var Uc;function H(a,b,c){var d=Uc;Uc=null;a||(a=d);d=this.constructor.pn;a||(a=d?[d]:[]);this.j=(d?0:-1)-(this.constructor.nn||0);this.h=null;this.O=a;a:{d=this.O.length;a=d-1;if(d&&(d=this.O[a],Mc(d))){this.l=a-this.j;this.i=d;break a}void 0!==b&&-1<b?(this.l=Math.max(b,a+1-this.j),this.i=null):this.l=Number.MAX_VALUE}if(c)for(b=0;b<c.length;b++)a=c[b],a<this.l?(a+=this.j,(d=this.O[a])?Array.isArray(d)&&Lc(d):this.O[a]=Vc):(Wc(this),(d=this.i[a])?Array.isArray(d)&&Lc(d):this.i[a]=Vc)}
var Vc=Object.freeze(Lc([]));function Wc(a){var b=a.l+a.j;a.O[b]||(a.i=a.O[b]={})}
function Xc(a,b,c){return-1===b?null:b>=a.l?a.i?a.i[b]:void 0:(void 0===c?0:c)&&a.i&&a.i[b]?a.i[b]:a.O[b+a.j]}
function Yc(a,b,c){c=void 0===c?!1:c;var d=Xc(a,b,c);null==d&&(d=Vc);d===Vc&&(d=Lc(d.slice()),I(a,b,d,c));return d}
function I(a,b,c,d){(void 0===d?0:d)||b>=a.l?(Wc(a),a.i[b]=c):a.O[b+a.j]=c;return a}
...
function bd(a,b,c){var d;a.h||(a.h={});var e=c?c.O:c;a.h[b]=c;return I(a,b,e,void 0===d?!1:d)}
function cd(a,b,c,d){var e=ad(a,d,b);c=c?c:new d;a=Yc(a,b);e.push(c);a.push(c.O)}
H.prototype.toJSON=function(){var a=this.O;return Nc?a:Rc(a,Sc)};
function dd(a,b){return Oc(b)}
H.prototype.toString=function(){return this.O.toString()};
H.prototype.clone=function(){var a=this.constructor,b=Rc(this.O,Tc);Uc=b;a=new a(b);Uc=null;ed(a,this);return a};
...
;function fd(){var a=this;this.promise=new Promise(function(b,c){a.resolve=b;a.reject=c})}
;function gd(a){this.i=!1;var b=a.program;a=a.globalName;var c=new fd;this.j=c.promise;this.l=t((0,y[a].a)(b,function(d,e){Promise.resolve().then(function(){c.resolve({Cb:d,hc:e})})},!0)).next().value;
this.fc=c.promise.then(function(){})}
gd.prototype.snapshot=function(a){if(this.i)throw Error("Already disposed");return this.j.then(function(b){var c=b.Cb;return new Promise(function(d){c(function(e){d(e)},[a.gb,
a.ic])})})};
gd.prototype.xb=function(a){if(this.i)throw Error("Already disposed");return this.l([a.gb,a.ic])};
gd.prototype.dispose=function(){this.i=!0;this.j.then(function(a){(a=a.hc)&&a()})};
gd.prototype.h=function(){return this.i};var hd=window;yb("csi.gstatic.com");yb("googleads.g.doubleclick.net");yb("pagead2.googlesyndication.com");yb("partner.googleadservices.com");yb("pubads.g.doubleclick.net");yb("securepubads.g.doubleclick.net");yb("tpc.googlesyndication.com");/*
...
var od=[nd("data"),nd("http"),nd("https"),nd("mailto"),nd("ftp"),new md(function(a){return/^[^:]*([/?#]|$)/.test(a)})];function pd(a){if(a instanceof jd)if(a instanceof kd)a=a.h;else throw Error("");else a=Pb(a);return a}
;function qd(a,b){a.src=Db(b);var c;b=(a.ownerDocument&&a.ownerDocument.defaultView||window).document;var d=null===(c=b.querySelector)||void 0===c?void 0:c.call(b,"script[nonce]");(c=d?d.nonce||d.getAttribute("nonce")||"":"")&&a.setAttribute("nonce",c)}
...
function ud(a,b){jb(b,function(c,d){c&&"object"==typeof c&&c.ea&&(c=c.da());"style"==d?a.style.cssText=c:"class"==d?a.className=c:"for"==d?a.htmlFor=c:vd.hasOwnProperty(d)?a.setAttribute(vd[d],c):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,c):a[d]=c})}
...
return a}
var Bd={yc:"allow-forms",zc:"allow-modals",Ac:"allow-orientation-lock",Bc:"allow-pointer-lock",Cc:"allow-popups",Dc:"allow-popups-to-escape-sandbox",Ec:"allow-presentation",Fc:"allow-same-origin",Gc:"allow-scripts",Hc:"allow-top-navigation",Ic:"allow-top-navigation-by-user-activation"},Dd=ab(function(){return Cd()});
...
;var Hd=(new Date).getTime();var Id=new function(a,b){this.flag=a;this.defaultValue=void 0===b?!1:b}(1959);function Jd(a){if(!a)return"";if(/^about:(?:blank|srcdoc)$/.test(a))return window.origin||"";a=a.split("#")[0].split("?")[0];a=a.toLowerCase();0==a.indexOf("//")&&(a=window.location.protocol+a);/^[\w\-]*:\/\//.test(a)||(a=window.location.href);var b=a.substring(a.indexOf("://")+3),c=b.indexOf("/");-1!=c&&(b=b.substring(0,c));c=a.substring(0,a.indexOf("://"));if(!c)throw Error("URI is missing protocol: "+a);if("http"!==c&&"https"!==c&&"chrome-extension"!==c&&"moz-extension"!==c&&"file"!==c&&"android-app"!==
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,n;a();return{reset:a,update:c,digest:d,Fb:function(){for(var p=d(),u="",r=0;r<p.length;r++)u+="0123456789ABCDEF".charAt(Math.floor(p[r]/16))+"0123456789ABCDEF".charAt(p[r]%16);return u}}}
...
function Nd(a){var b=Kd();b.update(a);return b.Fb().toLowerCase()}
;var Od={};function Pd(a){this.h=a||{cookie:""}}
m=Pd.prototype;m.isEnabled=function(){if(!y.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{Ua:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.un;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Ua}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
;function Wd(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];Na(d)?Wd.apply(null,d):Vd(d)}}
...
function Xd(a,b){a.F?b():(a.A||(a.A=[]),a.A.push(b))}
K.prototype.G=function(){if(this.A)for(;this.A.length;)this.A.shift()()};function Yd(a,b){this.type=a;this.h=this.target=b;this.defaultPrevented=this.j=!1}
...
function $d(a,b){b||(b={});b[be(a)]=!0;var c=a.stack||"";(a=a.Db)&&!b[be(a)]&&(c+="\nCaused by: ",a.stack&&0==a.stack.indexOf(a.toString())||(c+="string"===typeof a?a:a.message+"\n"),c+=$d(a,b));return c}
...
try{y.addEventListener("test",Ka,b),y.removeEventListener("test",Ka,b)}catch(c){}return a}();function de(a,b){Yd.call(this,a?a.type:"");this.relatedTarget=this.h=this.target=null;this.button=this.screenY=this.screenX=this.clientY=this.clientX=0;this.key="";this.charCode=this.keyCode=0;this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1;this.state=null;this.pointerId=0;this.pointerType="";this.i=null;a&&this.init(a,b)}
D(de,Yd);var ee={2:"touch",3:"pen",4:"mouse"};
de.prototype.init=function(a,b){var c=this.type=a.type,d=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement;this.h=b;if(b=a.relatedTarget){if(rc){a:{try{nc(b.nodeName);var e=!0;break a}catch(f){}e=!1}e||(b=null)}}else"mouseover"==c?b=a.fromElement:"mouseout"==c&&(b=a.toElement);this.relatedTarget=b;d?(this.clientX=void 0!==d.clientX?d.clientX:d.pageX,this.clientY=void 0!==d.clientY?d.clientY:d.pageY,this.screenX=d.screenX||0,this.screenY=d.screenY||
...
this.i=a;a.defaultPrevented&&de.U.preventDefault.call(this)};
de.prototype.stopPropagation=function(){de.U.stopPropagation.call(this);this.i.stopPropagation?this.i.stopPropagation():this.i.cancelBubble=!0};
de.prototype.preventDefault=function(){de.U.preventDefault.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var fe="closure_listenable_"+(1E6*Math.random()|0);var ge=0;function he(a,b,c,d,e){this.listener=a;this.proxy=null;this.src=b;this.type=c;this.capture=!!d;this.Ea=e;this.key=++ge;this.va=this.Aa=!1}
function ie(a){a.va=!0;a.listener=null;a.proxy=null;a.src=null;a.Ea=null}
;function je(a){this.src=a;this.listeners={};this.h=0}
je.prototype.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.h++);var g=ke(a,b,d,e);-1<g?(b=a[g],c||(b.Aa=!1)):(b=new he(b,this.src,f,!!d,e),b.Aa=c,a.push(b));return b};
...
function le(a,b){var c=b.type;c in a.listeners&&gb(a.listeners[c],b)&&(ie(b),0==a.listeners[c].length&&(delete a.listeners[c],a.h--))}
function ke(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.va&&f.listener==b&&f.capture==!!c&&f.Ea==d)return e}return-1}
;var me="closure_lm_"+(1E6*Math.random()|0),ne={},oe=0;function pe(a,b,c,d,e){if(d&&d.once)qe(a,b,c,d,e);else if(Array.isArray(b))for(var f=0;f<b.length;f++)pe(a,b[f],c,d,e);else c=re(c),a&&a[fe]?a.V(b,c,Oa(d)?!!d.capture:!!d,e):se(a,b,c,!1,d,e)}
...
function ye(a){if("number"!==typeof a&&a&&!a.va){var b=a.src;if(b&&b[fe])le(b.i,a);else{var c=a.type,d=a.proxy;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(ve(c),d):b.addListener&&b.removeListener&&b.removeListener(d);oe--;(c=te(b))?(le(c,a),0==c.h&&(c.src=null,b[me]=null)):ie(a)}}}
function ve(a){return a in ne?ne[a]:ne[a]="on"+a}
function we(a,b){if(a.va)a=!0;else{b=new de(b,this);var c=a.listener,d=a.Ea||a.src;a.Aa&&ye(a);a=c.call(d,b)}return a}
...
return a[ze]}
;function Ae(){K.call(this);this.i=new je(this);this.T=this;this.J=null}
D(Ae,K);Ae.prototype[fe]=!0;Ae.prototype.addEventListener=function(a,b,c,d){pe(this,a,b,c,d)};
Ae.prototype.removeEventListener=function(a,b,c,d){xe(this,a,b,c,d)};
function Be(a,b){var c=a.J;if(c){var d=[];for(var e=1;c;c=c.J)d.push(c),++e}a=a.T;c=b.type||b;"string"===typeof b?b=new Yd(b,a):b instanceof Yd?b.target=b.target||a:(e=b,b=new Yd(c,a),tb(b,e));e=!0;if(d)for(var f=d.length-1;!b.j&&0<=f;f--){var g=b.h=d[f];e=Ce(g,c,!0,b)&&e}b.j||(g=b.h=a,e=Ce(g,c,!0,b)&&e,b.j||(e=Ce(g,c,!1,b)&&e));if(d)for(f=0;!b.j&&f<d.length;f++)g=b.h=d[f],e=Ce(g,c,!1,b)&&e}
Ae.prototype.G=function(){Ae.U.G.call(this);if(this.i){var a=this.i,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,ie(d[e]);delete a.listeners[c];a.h--}}this.J=null};
Ae.prototype.V=function(a,b,c,d){return this.i.add(String(a),b,!1,c,d)};
function Ce(a,b,c,d){b=a.i.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.va&&g.capture==c){var h=g.listener,k=g.Ea||g.src;g.Aa&&le(a.i,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
;function De(a){var b,c;Ae.call(this);var d=this;this.C=this.l=0;this.S=null!==a&&void 0!==a?a:{M:function(e,f){return setTimeout(e,f)},
ca:clearTimeout};this.j=null!==(c=null===(b=window.navigator)||void 0===b?void 0:b.onLine)&&void 0!==c?c:!0;this.m=function(){return x(function(e){return w(e,Ee(d),0)})};
window.addEventListener("offline",this.m);window.addEventListener("online",this.m);this.C||Fe(this)}
v(De,Ae);De.prototype.dispose=function(){window.removeEventListener("offline",this.m);window.removeEventListener("online",this.m);this.S.ca(this.C);delete De.h};
De.prototype.H=function(){return this.j};
function Fe(a){a.C=a.S.M(function(){var b;return x(function(c){if(1==c.h)return a.j?(null===(b=window.navigator)||void 0===b?0:b.onLine)?c.o(3):w(c,Ee(a),3):w(c,Ee(a),3);Fe(a);c.h=0})},3E4)}
function Ee(a,b){return a.u?a.u:a.u=new Promise(function(c){var d,e,f;return x(function(g){switch(g.h){case 1:return d=window.AbortController?new window.AbortController:void 0,e=null===d||void 0===d?void 0:d.signal,f=!1,ta(g,2,3),d&&(a.l=a.S.M(function(){d.abort()},b||2E4)),w(g,fetch("/generate_204",{method:"HEAD",
signal:e}),5);case 5:f=!0;case 3:wa(g);a.u=void 0;a.l&&(a.S.ca(a.l),a.l=0);f!==a.j&&(a.j=f,a.j?Be(a,"networkstatus-online"):Be(a,"networkstatus-offline"));c(f);xa(g);break;case 2:va(g),f=!1,g.o(3)}})})}
;var Ge={Sm:"WEB_DISPLAY_MODE_UNKNOWN",Om:"WEB_DISPLAY_MODE_BROWSER",Qm:"WEB_DISPLAY_MODE_MINIMAL_UI",Rm:"WEB_DISPLAY_MODE_STANDALONE",Pm:"WEB_DISPLAY_MODE_FULLSCREEN"};function He(){this.data_=[];this.h=-1}
He.prototype.set=function(a,b){b=void 0===b?!0:b;0<=a&&52>a&&0===a%1&&this.data_[a]!=b&&(this.data_[a]=b,this.h=-1)};
He.prototype.get=function(a){return!!this.data_[a]};
function Ie(a){-1==a.h&&(a.h=eb(a.data_,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.h}
;function Je(){var a={};this.D=function(b,c){return null!=a[b]?a[b]:c}}
...
;var Me;
function Ne(){var a=y.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!G("Presto")&&(a=function(){var e=xd(document,"IFRAME");e.style.display="none";document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=Va(function(k){if(("*"==h||k.origin==h)&&k.data==g)this.port1.onmessage()},this);
...
var Ue=!1,Ve=new Oe;function We(){for(var a;a=Ve.remove();){try{a.h.call(a.scope)}catch(b){lc(b)}Le(Pe,a)}Ue=!1}
...
function Pf(a,b,c,d){if(3==c&&b.onRejected&&!b.j)for(;a&&a.A;a=a.j)a.A=!1;if(b.h)b.h.j=null,Uf(b,c,d);else try{b.j?b.i.call(b.context):Uf(b,c,d)}catch(e){Vf.call(null,e)}Le(Hf,b)}
...
var Vf=lc;function Mf(a){Za.call(this,a)}
...
D(Zf,Yf);function ag(a){this.data=a}
...
v(ng,H);ng.prototype.getKey=function(){return Xc(this,1)};
ng.prototype.getValue=function(){return Xc(this,2===Zc(this,og)?2:-1)};
ng.prototype.setValue=function(a){var b=Zc(this,og);b&&2!==b&&null!=a&&(this.h&&b in this.h&&(this.h[b]=void 0),I(this,b,void 0));return I(this,2,a)};
...
v(sg,H);sg.prototype.getPlayerType=function(){return Xc(this,36)};
sg.prototype.setHomeGroupInfo=function(a){return bd(this,81,a)};
...
function ih(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=gh(a,b,c,d);if(e)return e;e=++fh.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new dh(h);if(!zd(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new dh(h);
...
D(nh,K);nh.prototype.T=function(a){void 0===a.h&&eh(a);var b=a.h;void 0===a.i&&eh(a);this.i=new rd(b,a.i)};
...
;function Nh(a){var b=Oh;a=void 0===a?C("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=Hd;e.flash="0";a:{try{var f=b.h.top.location.href}catch(Sa){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);try{e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?hd:g;try{var h=g.history.length}catch(Sa){h=0}e.u_his=h;var k;e.u_h=null==(k=hd.screen)?void 0:k.height;var l;e.u_w=null==(l=hd.screen)?void 0:l.width;var n;e.u_ah=null==(n=hd.screen)?void 0:n.availHeight;var p;e.u_aw=
null==(p=hd.screen)?void 0:p.availWidth;var u;e.u_cd=null==(u=hd.screen)?void 0:u.colorDepth}catch(Sa){}h=b.h;try{var r=h.screenX;var z=h.screenY}catch(Sa){}try{var A=h.outerWidth;var J=h.outerHeight}catch(Sa){}try{var R=h.innerWidth;var S=h.innerHeight}catch(Sa){}try{var U=h.screenLeft;var Pc=h.screenTop}catch(Sa){}try{R=h.innerWidth,S=h.innerHeight}catch(Sa){}try{var $f=h.screen.availWidth;var co=h.screen.availTop}catch(Sa){}r=[U,Pc,r,z,$f,co,A,J,R,S];z=b.h.top;try{var pa=(z||window).document,ea=
"CSS1Compat"==pa.compatMode?pa.documentElement:pa.body;var Ia=(new sd(ea.clientWidth,ea.clientHeight)).round()}catch(Sa){Ia=new sd(-12245933,-12245933)}pa=Ia;Ia={};ea=new He;y.SVGElement&&y.document.createElementNS&&ea.set(0);z=Ed();z["allow-top-navigation-by-user-activation"]&&ea.set(1);z["allow-popups-to-escape-sandbox"]&&ea.set(2);y.crypto&&y.crypto.subtle&&ea.set(3);y.TextDecoder&&y.TextEncoder&&ea.set(4);ea=Ie(ea);Ia.bc=ea;Ia.bih=pa.height;Ia.biw=pa.width;Ia.brdim=r.join();b=b.i;pa="ka";Je.ka&&
Je.hasOwnProperty(pa)?pa=Je.ka:(ea=new Je,Je.ka=ea,Je.hasOwnProperty(pa),pa=ea);b=(Ia.vis=pa.D(Id.flag,Id.defaultValue)&&b.prerendering?3:{visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[b.visibilityState||b.webkitVisibilityState||b.mozVisibilityState||""]||0,Ia.wgl=!!hd.WebGLRenderingContext,Ia);c=d.call(c,e,b);c.ca_type="image";a&&(c.bid=a);return c}
...
return k}
;var ei=Dc||Ec;function fi(a){var b=Ub();return b?0<=b.toLowerCase().indexOf(a):!1}
;var gi={},hi=0;
...
g||b()},d));
Di=!1}}
function Oi(a,b,c){var d=zi;c=void 0===c?{}:c;var e=Math.round(O()),f=a.size;a=t(a);for(var g=a.next();!g.done;g=a.next()){var h=t(g.value);g=h.next().value;var k=h=h.next().value;h=new Eg;var l=Wi(d.config_||Qi());bd(h,1,l);for(l=0;l<k.length;l++)cd(h,3,k[l],Bg);(k=Hi[g])&&Xi(h,g,k);delete Hi[g];g="visitorOnlyApprovedKey"===g;Yi(h,e,g);Ti(c);a:{Nc=!0;try{var n=JSON.stringify(h.toJSON(),dd);break a}finally{Nc=!1}n=void 0}h=n;g=Vi(c,g,function(){f--;f||b()},function(){f--;
f||b()},void 0);
...
function Vi(a,b,c,d,e){return{retry:!0,onSuccess:c,onError:d,qb:a,Ma:b,kn:!!e,headers:{},postBodyFormat:"",postBody:""}}
...
function Yi(a,b,c){I(a,2,b);if(!c&&(b=F("EVENT_ID",void 0))){c=Zi();var d=new Cg;I(d,1,b);I(d,2,c);bd(a,5,d)}}
...
function cj(){var a=bj();a=Object.keys(Ge).indexOf(a);return-1===a?null:a}
;function dj(a,b,c,d,e){Qd.set(""+a,b,{Ua:c,path:"/",domain:void 0===d?"youtube.com":d,secure:void 0===e?!1:e})}
;var ej=C("ytglobal.prefsUserPrefsPrefs_")||{};B("ytglobal.prefsUserPrefsPrefs_",ej,void 0);function fj(){this.h=F("ALT_PREF_COOKIE_NAME","PREF");this.i=F("ALT_PREF_COOKIE_DOMAIN","youtube.com");var a=Qd.get(""+this.h,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(ej[d]=c.toString())}}}
...
function Qi(){return{innertubeApiKey:F("INNERTUBE_API_KEY",void 0),innertubeApiVersion:F("INNERTUBE_API_VERSION",void 0),Sa:F("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Ta:F("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),Kb:F("INNERTUBE_CONTEXT_CLIENT_NAME",1),innertubeContextClientVersion:F("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),nb:F("INNERTUBE_CONTEXT_HL",void 0),mb:F("INNERTUBE_CONTEXT_GL",void 0),Lb:F("INNERTUBE_HOST_OVERRIDE",void 0)||"",Nb:!!F("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),Mb:!!F("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
...
function Wi(a){var b=new zg,c=new sg;I(c,1,a.nb);I(c,2,a.mb);I(c,16,a.Kb);I(c,17,a.innertubeContextClientVersion);if(a.Sa){var d=a.Sa,e=new pg;d.coldConfigData&&I(e,1,d.coldConfigData);d.appInstallData&&I(e,6,d.appInstallData);d.coldHashData&&I(e,3,d.coldHashData);d.hotHashData&&I(e,5,d.hotHashData);bd(c,62,e)}(d=y.devicePixelRatio)&&1!=d&&I(c,65,d);d=F("EXPERIMENTS_TOKEN","");""!==d&&I(c,54,d);d=Yg();if(0<d.length){e=new ug;for(var f=0;f<d.length;f++){var g=new ng;I(g,1,d[f].key);g.setValue(d[f].value);
cd(e,15,g,ng)}bd(b,5,e)}pj(a,c);qj(a,c);rj(c);sj(a,c);tj(c);F("DELEGATED_SESSION_ID")&&!N("pageid_as_header_web")&&(a=new xg,I(a,3,F("DELEGATED_SESSION_ID")));a=t(Object.entries(Jh(F("DEVICE",""))));for(d=a.next();!d.done;d=a.next())e=t(d.value),d=e.next().value,e=e.next().value,"cbrand"===d?I(c,12,e):"cmodel"===d?I(c,13,e):"cbr"===d?I(c,87,e):"cbrver"===d?I(c,88,e):"cos"===d?I(c,18,e):"cosver"===d?I(c,19,e):"cplatform"===d&&I(c,42,e);bd(b,1,c);return b}
function pj(a,b,c){a=a.Ta;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=$c(b,qg,96)||new qg;var d=cj();null!==d&&I(c,3,d);bd(b,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=bj())}
function qj(a,b,c){a=a.Ta;if(("WEB_REMIX"===a||76===a)&&!N("music_web_display_mode_killswitch"))if(b){var d;c=null!=(d=$c(b,rg,70))?d:new rg;d=cj();null!==d&&I(c,10,d);bd(b,70,c)}else if(c){var e;c.client.pb=null!=(e=c.client.pb)?e:{};c.client.pb.webDisplayMode=bj()}}
...
function sj(a,b,c){if(a.appInstallData)if(b){var d;c=null!=(d=$c(b,pg,62))?d:new pg;I(c,6,a.appInstallData);bd(b,62,c)}else c&&(c.client.configInfo=c.client.configInfo||{},c.client.configInfo.appInstallData=a.appInstallData)}
...
function uj(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||F("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.hn||F("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().gn:b=Ud([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=F("SESSION_INDEX",0),N("pageid_as_header_web")&&(d["X-Goog-PageId"]=F("DELEGATED_SESSION_ID")));return d}
;function vj(a){a=Object.assign({},a);delete a.Authorization;var b=Ud();if(b){var c=new $e;c.update(F("INNERTUBE_API_KEY",void 0));c.update(b);a.hash=Ic(c.digest(),3)}return a}
...
wj.prototype.get=function(a,b){var c=void 0,d=!this.h;if(!d)try{c=this.h.get(a)}catch(e){d=!0}if(d&&(c=Qd.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
wj.prototype.remove=function(a){this.h&&this.h.remove(a);var b=this.i;Qd.remove(""+a,"/",void 0===b?"youtube.com":b)};var xj;function yj(){xj||(xj=new wj("yt.innertube"));return xj}
...
a);
if("AbortError"===e.name)return new P("UNKNOWN_ABORT",a,e.message);e.args=[Object.assign(Object.assign({},a),{name:"IdbError",rn:e.name})];e.level="WARNING";return e}
...
Dk.prototype.open=function(){function a(){var f,g,h,k,l,n,p,u,r,z;return x(function(A){switch(A.h){case 1:return h=null!==(f=Error().stack)&&void 0!==f?f:"",ta(A,2),w(A,c.j(c.name,c.options.version,e),4);case 4:k=A.i;for(var J=c.options,R=[],S=t(Object.keys(J.ta)),U=S.next();!U.done;U=S.next()){U=U.value;var Pc=J.ta[U],$f=void 0===Pc.Vb?Number.MAX_VALUE:Pc.Vb;!(k.h.version>=Pc.La)||k.h.version>=$f||k.h.objectStoreNames.contains(U)||R.push(U)}l=R;if(0===l.length){A.o(5);break}n=Object.keys(c.options.ta);
...
function Nk(){var a,b,c;return x(function(d){switch(d.h){case 1:a=Dj();if(null===a||void 0===a?0:a.hasSucceededOnce)return d.return(!0);var e;if(e=ei)e=/WebKit\/([0-9]+)/.exec(Ub()),e=!!(e&&600<=parseInt(e[1],10));e&&(e=/WebKit\/([0-9]+)/.exec(Ub()),e=!(e&&602<=parseInt(e[1],10)));if(e||qc)return d.return(!1);try{if(b=self,!(b.indexedDB&&b.IDBIndex&&b.IDBKeyRange&&b.IDBObjectStore))return d.return(!1)}catch(f){return d.return(!1)}if(!("IDBTransaction"in self&&"objectStoreNames"in IDBTransaction.prototype))return d.return(!1);
...
;new fd;function Rk(a){if(!Kj())throw a=new P("AUTH_INVALID",{dbName:a}),Hj(a),a;var b=Lj();return{actualName:a+":"+b,publicName:a,userIdentifier:b}}
...
this.qa=function(){};
this.now=Date.now;this.sa=!1;this.yb=null!==(b=a.yb)&&void 0!==b?b:100;this.vb=null!==(c=a.vb)&&void 0!==c?c:1;this.tb=null!==(d=a.tb)&&void 0!==d?d:2592E6;this.rb=null!==(e=a.rb)&&void 0!==e?e:12E4;this.ub=null!==(f=a.ub)&&void 0!==f?f:5E3;this.B=null!==(g=a.B)&&void 0!==g?g:void 0;this.Da=!!a.Da;this.Ca=null!==(h=a.Ca)&&void 0!==h?h:.1;this.Ha=null!==(k=a.Ha)&&void 0!==k?k:10;a.handleError&&(this.handleError=a.handleError);a.qa&&(this.qa=a.qa);a.sa&&(this.sa=a.sa);this.D=a.D;this.S=a.S;this.I=a.I;
this.L=a.L;this.Y=a.Y;this.Xa=a.Xa;this.Wa=a.Wa;this.B&&(!this.D||this.D("networkless_logging"))&&$k(this)}
function $k(a){return x(function(b){if(1==b.h)return!a.B||a.sa?b.return():a.Da&&Math.random()<=a.Ca?w(b,a.I.Eb(a.B),2):b.o(2);al(a);a.L.H()&&a.wa();a.L.V(a.Xa,a.wa.bind(a));a.L.V(a.Wa,a.eb.bind(a));a.h=!0;b.h=0})}
...
m.wa=function(){var a=this;if(!this.B)throw Yj("throttleSend");this.i||(this.i=this.S.M(function(){var b;return x(function(c){if(1==c.h)return w(c,a.I.lb("NEW",a.B),2);if(3!=c.h)return b=c.i,b?w(c,bl(a,b),3):(a.eb(),c.return());a.i&&(a.i=0,a.wa());c.h=0})},this.yb))};
m.eb=function(){this.S.ca(this.i);this.i=0};
function bl(a,b){var c,d;return x(function(e){switch(e.h){case 1:if(!a.B)throw c=Yj("immediateSend"),c;if(void 0===b.id){e.o(2);break}return w(e,a.I.Pb(b.id,a.B),3);case 3:(d=e.i)?b=d:a.qa(Error("The request cannot be found in the database."));case 2:if(dl(a,b,a.tb)){e.o(4);break}a.qa(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.o(5);break}return w(e,a.I.oa(b.id,a.B),5);case 5:return e.return();case 4:b.skipRetry||(b=el(a,b));if(!b){e.o(0);break}if(!b.skipRetry||
...
!g&&a.potentialEsfErrorCounter>a.Ha)return h.return();a.potentialEsfErrorCounter++;if(void 0===(null===b||void 0===b?void 0:b.id)){h.o(8);break}return b.sendCount<a.vb?w(h,a.I.Ya(b.id,a.B),12):w(h,a.I.oa(b.id,a.B),8);case 12:a.S.M(function(){a.L.H()&&a.wa()},a.ub);
case 8:c(e,f),h.h=0}})};
...
function al(a){if(!a.B)throw Yj("retryQueuedRequests");a.I.lb("QUEUED",a.B).then(function(b){b&&!dl(a,b,a.rb)?a.S.M(function(){return x(function(c){if(1==c.h)return void 0===b.id?c.o(2):w(c,a.I.Ya(b.id,a.B),2);al(a);c.h=0})}):a.L.H()&&a.wa()})}
function cl(a,b){a.zb&&!a.L.H()?a.zb(b):a.handleError(b)}
...
;var Sl=Xg("network_polling_interval",3E4);function T(){Ae.call(this);this.K=0;this.P=this.m=!1;this.l=this.Qa();N("use_shared_nsm")?(De.h||(De.h=new De(uh)),this.j=De.h):(Tl(this),Ul(this))}
v(T,Ae);function Vl(){if(!T.h){var a=C("yt.networkStatusManager.instance")||new T;B("yt.networkStatusManager.instance",a,void 0);T.h=a}return T.h}
...
m.Gb=function(){this.P=!0};
m.V=function(a,b){return N("use_shared_nsm")&&this.j?this.j.V(a,b):Ae.prototype.V.call(this,a,b)};
...
m.Z=function(a){var b=this;if(N("use_shared_nsm")&&this.j){var c=Ee(this.j,a);c.then(function(d){N("use_cfr_monitor")&&Nl().X("generate_204",d)});
...
signal:f}),5);case 5:g=!0;case 3:wa(h);N("use_cfr_monitor")&&Nl().X("generate_204",g);b.u=void 0;b.C&&uh.ca(b.C);g!==b.l&&(b.l=g,b.l&&b.m?Be(b,"ytnetworkstatus-online"):b.m&&Be(b,"ytnetworkstatus-offline"));d(g);xa(h);break;case 2:va(h),g=!1,h.o(3)}})})};
T.prototype.sendNetworkCheckRequest=T.prototype.Z;T.prototype.listen=T.prototype.V;T.prototype.enableErrorFlushing=T.prototype.Gb;T.prototype.getWindowStatus=T.prototype.Qa;T.prototype.monitorNetworkStatusChange=T.prototype.Qb;T.prototype.networkStatusHint=T.prototype.ga;T.prototype.isNetworkAvailable=T.prototype.H;T.getInstance=Vl;function Xl(a){a=void 0===a?{}:a;Ae.call(this);var b=this;this.l=this.K=0;this.m="ytnetworkstatus-offline";this.u="ytnetworkstatus-online";N("use_shared_nsm")&&(this.m="networkstatus-offline",this.u="networkstatus-online");this.j=Vl();var c=C("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.j);c&&c(a.jb);a.Fa&&!N("use_shared_nsm")&&(c=C("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j))&&c();if(c=C("yt.networkStatusManager.instance.listen").bind(this.j))a.Ia?
(this.Ia=a.Ia,c(this.u,function(){Yl(b,"publicytnetworkstatus-online");N("use_shared_nsm")&&a.Fa&&Rl()}),c(this.m,function(){Yl(b,"publicytnetworkstatus-offline")})):(c(this.u,function(){Be(b,"publicytnetworkstatus-online");
N("use_shared_nsm")&&a.Fa&&Rl()}),c(this.m,function(){Be(b,"publicytnetworkstatus-offline")}))}
v(Xl,Ae);Xl.prototype.H=function(){var a=C("yt.networkStatusManager.instance.isNetworkAvailable").bind(this.j);return a?a():!0};
...
function Yl(a,b){a.Ia?a.l?(uh.ca(a.K),a.K=uh.M(function(){a.C!==b&&(Be(a,b),a.C=b,a.l=O())},a.Ia-(O()-a.l))):(Be(a,b),a.C=b,a.l=O()):Be(a,b)}
;var Zl;function $l(){Zk.call(this,{I:{Eb:Fl,oa:El,lb:Bl,Pb:Cl,Ya:Dl,set:zl},L:am(),handleError:Sg,qa:Tg,Y:bm,now:O,zb:Ql,S:th(),Xa:"publicytnetworkstatus-online",Wa:"publicytnetworkstatus-offline",Da:!0,Ca:.1,Ha:Xg("potential_esf_error_limit",10),D:N,sa:!Kj()});this.j=new fd;this.Da&&Math.random()<=this.Ca&&this.B&&Kl(this.B);N("networkless_immediately_drop_sw_health_store")&&cm(this);N("networkless_immediately_drop_all_requests")&&Gl();Yk("LogsDatabaseV2")}
...
a.options.onError=function(e,f){var g;return x(function(h){switch(h.h){case 1:N("use_cfr_monitor")&&Nl().X(a.url,!1);g=fl(f);if(!(N("nwl_consider_error_code")&&g||!N("nwl_consider_error_code")&&xm()<=Xg("potential_esf_error_limit",10))){h.o(2);break}return w(h,mm().Z(),3);case 3:if(mm().H()){h.o(2);break}c(e,f);if(!N("nwl_consider_error_code")||void 0===(null===a||void 0===a?void 0:a.id)){h.o(5);break}return w(h,Dl(a.id,b,!1),5);case 5:return h.return();case 2:if(N("nwl_consider_error_code")&&!g&&
xm()>Xg("potential_esf_error_limit",10))return h.return();C("ytNetworklessLoggingInitializationOptions")&&jm.potentialEsfErrorCounter++;hm++;if(void 0===(null===a||void 0===a?void 0:a.id)){h.o(7);break}return 1>a.sendCount?w(h,Dl(a.id,b),11):w(h,El(a.id,b),7);case 11:uh.M(function(){mm().H()&&nm()},5E3);
case 7:c(e,f),h.h=0}})};
...
c.onFetchSuccess=function(S,U){Aj(A);R(S,U)}}try{z&&d.retry&&!d.qb.bypassNetworkless?(g.method="POST",d.qb.writeThenSend?N("use_new_nwl")?dm().writeThenSend(r,g):qm(r,g):N("use_new_nwl")?dm().sendAndWrite(r,g):um(r,g)):(g.method="POST",g.postParams||(g.postParams={}),Xh(r,g))}catch(S){if("InvalidAccessError"==S.name)A&&(Aj(A),A=0),Tg(Error("An extension is blocking network request."));
...
timeout:d.timeout,withCredentials:!0};g.headers["Content-Type"]||(g.headers["Content-Type"]="application/json");var h="";(f=a.config_.Lb)&&(h=f);var k=a.config_.Nb||!1,l=uj(k,h,d);Object.assign(g.headers,l);(f=g.headers.Authorization)&&!h&&(g.headers["x-origin"]=window.location.origin);var n="/youtubei/"+a.config_.innertubeApiVersion+"/"+b,p={alt:"json"},u=a.config_.Mb&&f;N("omit_innertube_api_key_for_bearer_auth_header")&&(u=u&&f.startsWith("Bearer"));u||(p.key=a.config_.innertubeApiKey);var r=Lh(""+
h+n,p||{},!0);N("use_new_nwl")||rm()?Ok().then(function(z){e(z)}):e(!1)}
...
Em();c=t(a.fa);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.qn)){a=d.weight;break a}a=t(a.ba);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.cb(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=t(zm);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ga[l.name])for(e=t(c.Ga[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+
...
Vj:11070,Wj:11074,Xj:17880,kk:14001,mk:30709,nk:30707,pk:30711,qk:30710,rk:30708,lk:26984,sk:63648,tk:63649,uk:51879,vk:111059,wk:5754,xk:20445,zk:130975,yk:130976,Ak:110386,Bk:113746,Ck:66557,Ek:17310,Fk:28631,Gk:21589,Hk:68012,Ik:60480,Jk:138664,Kk:141121,Lk:31571,Mk:76980,Nk:41577,Ok:45469,Pk:38669,Qk:13768,Rk:13777,Sk:62985,Tk:4724,Uk:59369,Vk:43927,Wk:43928,Xk:12924,Yk:100355,bl:56219,dl:27669,fl:10337,al:47896,il:122629,kl:139723,jl:139722,ll:121258,ml:107598,nl:127991,ol:96639,pl:107536,ql:130169,
rl:96661,sl:96658,ul:116646,vl:121122,wl:96660,xl:127738,yl:127083,zl:104443,Al:96659,Bl:106442,Cl:134840,Dl:63667,El:63668,Fl:63669,Gl:130686,Hl:78314,Il:55761,Jl:127098,Kl:134841,Ll:96368,Ml:67374,Nl:48992,Ol:49956,Pl:31961,Ql:26388,Rl:23811,Sl:5E4,Tl:126250,Ul:96370,Vl:47355,Wl:47356,Xl:37935,Yl:45521,Zl:21760,am:83769,bm:49977,cm:49974,dm:93497,em:93498,fm:34325,gm:140759,hm:115803,im:123707,jm:100081,km:35309,lm:68314,mm:25602,nm:100339,om:59018,pm:18248,qm:50625,rm:9729,sm:37168,tm:37169,um:21667,
vm:16749,wm:18635,xm:39305,ym:18046,zm:53969,Am:8213,Bm:93926,Cm:102852,Dm:110099,Em:22678,Fm:69076,Gm:137575,Im:139224,Jm:100856,Km:17736,Lm:3832,Mm:55759,Nm:64031,Tm:93044,Um:93045,Vm:34388,Wm:17657,Xm:17655,Ym:39579,Zm:39578,an:77448,bn:8196,cn:11357,dn:69877,en:8197,fn:82039};function Wm(){var a=qb(Xm),b;return Lf(new Ef(function(c,d){a.onSuccess=function(e){Rh(e)?c(new Ym(e)):d(new Zm("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
;function cn(){if(Sd())return!0;var a=F("INNERTUBE_CLIENT_NAME");return!a||"WEB"!==a&&"MWEB"!==a||ei&&fi("applewebkit")&&!fi("version")&&(!fi("safari")||fi("gsa/"))||tc&&fi("version/")?!0:(a=Qd.get("CONSENT",void 0))?a.startsWith("YES+"):!0}
...
return a.join("")}
;var on,pn=y.ytLoggingDocDocumentNonce_;pn||(pn=nn(),Xa("ytLoggingDocDocumentNonce_",pn));on=pn;var qn={Gf:0,Xc:1,gd:2,Ri:3,If:4,Hm:5,Gj:6,Zk:7,Dk:8,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS"};function rn(a){this.h=a}
...
function En(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return Ic(b,3)}
...
function Ko(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.Sb?c.Sb:c.layer;var e=yn(d);d=wn(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=F("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=a.client;h=f;var l=c.hb,n=c.cttAuthInfo,p=c.mn,u=Fn(),r={csn:u,pageVe:(new rn({veType:b,youtubeData:g})).getAsJson()};h&&h.visualElement?(r.implicitGesture=
{parentCsn:h.clientScreenNonce,gesturedVe:h.visualElement.getAsJson()},p&&(r.implicitGesture.gestureType=p)):h&&Tm(new Jj("newScreen() parent element does not have a VE - rootVe",b));l&&(r.cloneCsn=l);l={cttAuthInfo:n,ha:u};k?aj("screenCreated",r,k,l):V("screenCreated",r,l);ml(pl,new Cn(u));var z=u}catch(A){Um(A,{tn:b,rootVe:d,parentVisualElement:void 0,ln:e,sn:f,hb:c.hb});Sm(A);return}Bn(z,b,c.layer,c.cttAuthInfo);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=N("screen_manager_skip_hide_killswitch"))){a:{b=
t(Object.values(qn));for(f=b.next();!f.done;f=b.next())if(yn(f.value)==e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,f=!0,k=(f=void 0===f?!1:f)?16:8,d={csn:e,ve:d.getAsJson(),eventType:k},f={cttAuthInfo:An(e),ha:e,Ib:f},"UNDEFINED_CSN"==e?In("visualElementHidden",d,f):b?aj("visualElementHidden",d,b,f):V("visualElementHidden",d,f));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=z||"");zo("csn",z);Jn.getInstance().clear();d=wn(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(N("web_mark_root_visible")||
...
function Vo(a,b,c,d){d=void 0===d?null:d;var e=xd(document,"SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
e.onreadystatechange=function(){switch(e.readyState){case "loaded":case "complete":e.onload()}};
d&&e.setAttribute("nonce",d);qd(e,vf(a));a=document.getElementsByTagName("head")[0]||document.body;a.insertBefore(e,a.firstChild);return e}
...
function cp(a,b,c,d,e,f,g){g=void 0===g?!1:g;c?(a.i=!0,Ro(c,function(){a.i=!1;var h=0<=c.indexOf("/th/");(h?window.trayride:window.botguard)?dp(a,d,!!g,h,e):(Wo(c),Tm(new Jj("Unable to load Botguard","from "+c)))},f)):b&&(f=xd(document,"SCRIPT"),f.textContent=b,f.nonce=bc(),document.head.appendChild(f),document.head.removeChild(f),((b=b.includes("trayride"))?window.trayride:window.botguard)?dp(a,d,!!g,b,e):Tm(Error("Unable to load Botguard from JS")))}
bp.prototype.isInitialized=function(){return!!this.h};
function dp(a,b,c,d,e){var f,g;if(N("use_bg_facade"))if(c=d?"trayride":"botguard",window[c])try{var h=new gd({program:b,globalName:c});e&&h.fc.then(function(){e(b)});
...
bp.prototype.invoke=function(a){a=void 0===a?{}:a;if(this.h){if(this.h.xb)return this.h.xb({gb:a});if(this.h.hot)return this.h.hot(void 0,void 0,a);if(this.h.invoke)return this.h.invoke(void 0,void 0,a);Tm(Error("VM has unknown interface"))}return null};
...
m.Jb=function(){this.isReady=!0;this.sendMessage("initialDelivery",this.Pa());this.sendMessage("onReady");E(this.i,this.wb,this);this.i=[]};
...
m.onReady=function(){var a=this.Jb.bind(this);this.h.i=a};
...
m.dispose=function(){sp.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function zp(a){K.call(this);this.i={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.sb,this)}
...
m.G=function(){var a=this.connection;a.h()||Wf(a.i,"command",this.sb,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);K.prototype.G.call(this)};function Cp(a,b){zp.call(this,b);this.api=a;this.start()}
...
Cp.prototype.G=function(){zp.prototype.G.call(this);delete this.api};function Dp(a){a=void 0===a?!1:a;K.call(this);this.i=new L(a);Xd(this,Wa(Vd,this.i))}
...
Ep.prototype.G=function(){this.destination=this.j=null;Dp.prototype.G.call(this)};function Fp(a,b,c){K.call(this);this.destination=a;this.origin=c;this.i=ih(window,"message",this.j.bind(this));this.connection=new Ep(this,a,b);Xd(this,Wa(Vd,this.connection))}
...
function Kp(a){var b=xd(document,"A");yb("This URL is never added to the DOM");Zb(b,new Nb(a,Ob));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+dc(a)}
...
v(Np,Mp);function Op(a,b,c,d){K.call(this);var e=this;this.K=b;this.webPlayerContextConfig=d;this.Ja=!1;this.api={};this.xa=this.u=null;this.P=new L;this.i={};this.aa=this.ya=this.elementId=this.Ka=this.config=null;this.T=!1;this.l=this.C=null;this.za={};this.Ab=["onReady"];this.lastError=null;this.bb=NaN;this.J={};this.Bb=new Np(this);this.na=0;this.j=this.m=a;Xd(this,Wa(Vd,this.P));Pp(this);Qp(this);Xd(this,Wa(Vd,this.Bb));c?this.na=lh(function(){e.loadNewVideoConfig(c)},0):d&&(Rp(this),Sp(this))}
...
function Xp(a){var b=td(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
...
m.addEventListener=function(a,b){var c=this,d=Vp(this,b);d&&(0<=bb(this.Ab,a)||this.i[a]||(b=fq(this,a),this.u&&this.u(a,b)),this.P.subscribe(a,d),"onReady"===a&&this.isReady()&&lh(function(){d(c.api)},0))};
...
F("PL_ATT")&&fp.dispose();for(var a=0,b=Yo.length;a<b;a++)uh.ca(Yo[a]);Yo.length=0;Wo("//static.doubleclick.net/instream/ad_status.js");Zo=!1;M("DCLKSTAT",0);(0,Wd)(mq,lq);kq&&(kq.removeEventListener("onVideoDataChange",nq),kq.destroy())});
